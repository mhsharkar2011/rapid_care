    ...
    <div class="row my-5">
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
          <div class="card card-signin">
            <div class="card-body">
              <h5 class="card-title text-center text-uppercase text-info "></h5>
              @if (Route::is('frontEnd*'))
              <form class="form-group" action="{{ route('frontEnd.login.store') }}" method="POST">
                @csrf
                ...
                <div class="text-center">
                  <button class="btn btn-sm btn-info text-white btn-block text-uppercase" type="submit">Sign in</button>
