    ...
    <style>
        ...
        * {
        ...
        .login-card::before {
            ...
            width: 200%;
            height: 200%;
            background: radial-gradient(circle at 30% 20%, rgba(139, 92, 246, 0.08) 0%, transparent 60%);
            pointer-events: none;
        }
        ...
        @media (prefers-color-scheme: light) {
            ...
            .form-control:-webkit-autofill {
                -webkit-box-shadow: 0 0 0 30px rgba(0, 0, 0, 0.03) inset !important;
            ...
            <form class="login-form" action="{{ route('admin.store') }}" method="POST">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control" name="email" value="monir@gmail.com" placeholder="Email Address" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control" name="password" value="123456" placeholder="Password" id="password" required>
                ...
                <div class="btn-group">
                    ...
                    <a href="{{ route('admin.store') }}" class="btn-secondary-custom">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
